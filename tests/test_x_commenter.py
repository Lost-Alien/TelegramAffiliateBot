...
def test_config_keys_and_limits():
    """Test 1: Verify daily limits (20 replies/day), run limits, search topics, and prompt rules."""
    assert config_x.MAX_REPLIES_PER_RUN == 2
    assert config_x.MAX_REPLIES_PER_DAY == 20
    assert config_x.MIN_DELAY_BETWEEN_REPLIES_SEC == 30
    assert config_x.MAX_QUOTE_REPOSTS_PER_DAY == 8
